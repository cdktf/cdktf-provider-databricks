...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v8/recipient"
...
&recipient.RecipientConfig {
	...
	Id: *string,
	IpAccessList: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.recipient.RecipientIpAccessListStruct,
	SharingCode: *string,
	Tokens: interface{},
}
```
