...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v6/recipient"
...
&recipient.RecipientConfig {
	...
	Id: *string,
	IpAccessList: github.com/cdktf/cdktf-provider-databricks-go/databricks/v6.recipient.RecipientIpAccessList,
	SharingCode: *string,
	Tokens: interface{},
}
```
