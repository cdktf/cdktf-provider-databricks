...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v14/alert"
...
&alert.AlertCondition {
	Op: *string,
	Operand: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.alert.AlertConditionOperand,
	EmptyResultState: *string,
	Threshold: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.alert.AlertConditionThreshold,
}
```
...
&alert.AlertConditionOperand {
	Column: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.alert.AlertConditionOperandColumn,
}
```
...
&alert.AlertConditionThreshold {
	Value: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.alert.AlertConditionThresholdValue,
}
```
...
&alert.AlertConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.alert.AlertCondition,
	DisplayName: *string,
	QueryId: *string,
	CustomBody: *string,
