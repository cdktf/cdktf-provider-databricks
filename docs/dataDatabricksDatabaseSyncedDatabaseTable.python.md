...
```python
spec_input: IResolvable | DataDatabricksDatabaseSyncedDatabaseTableSpec
```
...
```python
internal_value: IResolvable | DataDatabricksDatabaseSyncedDatabaseTableSpec
```
