...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v14/vectorsearchendpoint"
...
&vectorsearchendpoint.VectorSearchEndpointConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.vectorSearchEndpoint.VectorSearchEndpointTimeouts,
}
```
