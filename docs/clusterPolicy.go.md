...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v14/clusterpolicy"
...
&clusterpolicy.ClusterPolicyLibraries {
	Cran: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.clusterPolicy.ClusterPolicyLibrariesCran,
	Egg: *string,
	Jar: *string,
	Maven: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.clusterPolicy.ClusterPolicyLibrariesMaven,
	Pypi: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.clusterPolicy.ClusterPolicyLibrariesPypi,
	Requirements: *string,
	Whl: *string,
}
```
