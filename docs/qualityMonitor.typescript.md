...
```typescript
public putDataClassificationConfig(value: QualityMonitorDataClassificationConfig): void
```
...
```typescript
public putInferenceLog(value: QualityMonitorInferenceLog): void
```
...
```typescript
public putNotifications(value: QualityMonitorNotifications): void
```
...
```typescript
public putSchedule(value: QualityMonitorSchedule): void
```
...
```typescript
public putSnapshot(value: QualityMonitorSnapshot): void
```
...
```typescript
public putTimeouts(value: QualityMonitorTimeouts): void
```
...
```typescript
public putTimeSeries(value: QualityMonitorTimeSeries): void
```
...
| <code><a href="#@cdktf/provider-databricks.qualityMonitor.QualityMonitor.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/provider-databricks.qualityMonitor.QualityMonitorTimeouts">QualityMonitorTimeouts</a></code> | *No description.* |
...
```typescript
public readonly dataClassificationConfig: QualityMonitorDataClassificationConfigOutputReference;
```
...
```typescript
public readonly inferenceLog: QualityMonitorInferenceLogOutputReference;
```
...
```typescript
public readonly notifications: QualityMonitorNotificationsOutputReference;
```
...
```typescript
public readonly schedule: QualityMonitorScheduleOutputReference;
```
...
```typescript
public readonly snapshot: QualityMonitorSnapshotOutputReference;
```
...
```typescript
public readonly timeouts: QualityMonitorTimeoutsOutputReference;
```
...
```typescript
public readonly timeSeries: QualityMonitorTimeSeriesOutputReference;
```
...
```typescript
public readonly dataClassificationConfigInput: QualityMonitorDataClassificationConfig;
```
...
```typescript
public readonly inferenceLogInput: QualityMonitorInferenceLog;
```
...
```typescript
public readonly notificationsInput: QualityMonitorNotifications;
```
...
```typescript
public readonly scheduleInput: QualityMonitorSchedule;
```
...
```typescript
public readonly snapshotInput: QualityMonitorSnapshot;
```
...
```typescript
public readonly timeoutsInput: IResolvable | QualityMonitorTimeouts;
```

- *Type:* cdktf.IResolvable | <a href="#@cdktf/provider-databricks.qualityMonitor.QualityMonitorTimeouts">QualityMonitorTimeouts</a>
...
```typescript
public readonly timeSeriesInput: QualityMonitorTimeSeries;
```
...
| <code><a href="#@cdktf/provider-databricks.qualityMonitor.QualityMonitorConfig.property.skipBuiltinDashboard">skipBuiltinDashboard</a></code> | <code>boolean \| cdktf.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.49.0/docs/resources/quality_monitor#skip_builtin_dashboard QualityMonitor#skip_builtin_dashboard}. |
...
```typescript
public readonly dataClassificationConfig: QualityMonitorDataClassificationConfig;
```
...
```typescript
public readonly inferenceLog: QualityMonitorInferenceLog;
```
...
```typescript
public readonly notifications: QualityMonitorNotifications;
```
...
```typescript
public readonly schedule: QualityMonitorSchedule;
```
...
```typescript
public readonly snapshot: QualityMonitorSnapshot;
```
...
```typescript
public readonly timeouts: QualityMonitorTimeouts;
```
...
```typescript
public readonly timeSeries: QualityMonitorTimeSeries;
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-databricks.qualityMonitor.QualityMonitorDataClassificationConfig.property.enabled">enabled</a></code> | <code>boolean \| cdktf.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.49.0/docs/resources/quality_monitor#enabled QualityMonitor#enabled}. |
...
```typescript
public readonly onFailure: QualityMonitorNotificationsOnFailure;
```
...
```typescript
public readonly onNewClassificationTagDetected: QualityMonitorNotificationsOnNewClassificationTagDetected;
```
...
const qualityMonitorTimeouts: qualityMonitor.QualityMonitorTimeouts = { ... }
```
...
new qualityMonitor.QualityMonitorDataClassificationConfigOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```
...
```typescript
public readonly internalValue: QualityMonitorDataClassificationConfig;
```
...
new qualityMonitor.QualityMonitorInferenceLogOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```
...
```typescript
public readonly internalValue: QualityMonitorInferenceLog;
```
...
new qualityMonitor.QualityMonitorNotificationsOnFailureOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```
...
```typescript
public readonly internalValue: QualityMonitorNotificationsOnFailure;
```
...
new qualityMonitor.QualityMonitorNotificationsOnNewClassificationTagDetectedOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```
...
```typescript
public readonly internalValue: QualityMonitorNotificationsOnNewClassificationTagDetected;
```
...
new qualityMonitor.QualityMonitorNotificationsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```
...
```typescript
public putOnFailure(value: QualityMonitorNotificationsOnFailure): void
```
...
```typescript
public putOnNewClassificationTagDetected(value: QualityMonitorNotificationsOnNewClassificationTagDetected): void
```
...
```typescript
public readonly onFailure: QualityMonitorNotificationsOnFailureOutputReference;
```
...
```typescript
public readonly onNewClassificationTagDetected: QualityMonitorNotificationsOnNewClassificationTagDetectedOutputReference;
```
...
```typescript
public readonly onFailureInput: QualityMonitorNotificationsOnFailure;
```
...
```typescript
public readonly onNewClassificationTagDetectedInput: QualityMonitorNotificationsOnNewClassificationTagDetected;
```
...
```typescript
public readonly internalValue: QualityMonitorNotifications;
```
...
new qualityMonitor.QualityMonitorScheduleOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```
...
```typescript
public readonly internalValue: QualityMonitorSchedule;
```
...
new qualityMonitor.QualityMonitorSnapshotOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```
...
```typescript
public readonly internalValue: QualityMonitorSnapshot;
```
...
new qualityMonitor.QualityMonitorTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-databricks.qualityMonitor.QualityMonitorTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-databricks.qualityMonitor.QualityMonitorTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/provider-databricks.qualityMonitor.QualityMonitorTimeouts">QualityMonitorTimeouts</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | QualityMonitorTimeouts;
```
...
new qualityMonitor.QualityMonitorTimeSeriesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```
...
```typescript
public readonly internalValue: QualityMonitorTimeSeries;
```
