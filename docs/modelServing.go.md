...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v8/modelserving"
...
&modelserving.ModelServingConfig {
	...
	Config: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.modelServing.ModelServingConfigA,
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.modelServing.ModelServingTimeouts,
}
```
...
&modelserving.ModelServingConfigA {
	...
	TrafficConfig: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.modelServing.ModelServingConfigTrafficConfig,
}
```
