...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v5/mlflowexperiment"
...
&mlflowexperiment.MlflowExperimentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-databricks-go/databricks/v5.mlflowExperiment.MlflowExperimentTimeouts,
}
```
