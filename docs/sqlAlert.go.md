...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v6/sqlalert"
...
&sqlalert.SqlAlertConfig {
	...
	Name: *string,
	Options: github.com/cdktf/cdktf-provider-databricks-go/databricks/v6.sqlAlert.SqlAlertOptions,
	QueryId: *string,
	Id: *string,
	Parent: *string,
	Rearm: *f64,
