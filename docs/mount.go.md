...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v8/mount"
...
| <code><a href="#@cdktf/provider-databricks.mount.MountAbfs.property.initializeFileSystem">InitializeFileSystem</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.19.0/docs/resources/mount#initialize_file_system Mount#initialize_file_system}. |
...
&mount.MountConfig {
	...
	Abfs: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.mount.MountAbfs,
	Adl: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.mount.MountAdl,
	ClusterId: *string,
	EncryptionType: *string,
	ExtraConfigs: *map[string]*string,
	Gs: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.mount.MountGs,
	Id: *string,
	Name: *string,
	ResourceId: *string,
	S3: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.mount.MountS3,
	Timeouts: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.mount.MountTimeouts,
	Uri: *string,
	Wasb: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.mount.MountWasb,
}
```
...
| <code><a href="#@cdktf/provider-databricks.mount.MountConfig.property.extraConfigs">ExtraConfigs</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.19.0/docs/resources/mount#extra_configs Mount#extra_configs}. |
