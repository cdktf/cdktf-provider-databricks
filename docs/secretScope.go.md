...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v8/secretscope"
...
&secretscope.SecretScopeConfig {
	...
	KeyvaultMetadata: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.secretScope.SecretScopeKeyvaultMetadata,
}
```
