...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v7/secretscope"
...
&secretscope.SecretScopeConfig {
	...
	KeyvaultMetadata: github.com/cdktf/cdktf-provider-databricks-go/databricks/v7.secretScope.SecretScopeKeyvaultMetadata,
}
```
