...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v10/secretscope"
...
&secretscope.SecretScopeConfig {
	...
	KeyvaultMetadata: github.com/cdktf/cdktf-provider-databricks-go/databricks/v10.secretScope.SecretScopeKeyvaultMetadata,
}
```
