...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v14/secretscope"
...
&secretscope.SecretScopeConfig {
	...
	KeyvaultMetadata: github.com/cdktf/cdktf-provider-databricks-go/databricks/v14.secretScope.SecretScopeKeyvaultMetadata,
}
```
