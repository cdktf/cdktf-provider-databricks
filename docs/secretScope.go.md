...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v11/secretscope"
...
&secretscope.SecretScopeConfig {
	...
	KeyvaultMetadata: github.com/cdktf/cdktf-provider-databricks-go/databricks/v11.secretScope.SecretScopeKeyvaultMetadata,
}
```
