...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v10/mlflowwebhook"
...
&mlflowwebhook.MlflowWebhookConfig {
	...
	Events: *[]*string,
	Description: *string,
	HttpUrlSpec: github.com/cdktf/cdktf-provider-databricks-go/databricks/v10.mlflowWebhook.MlflowWebhookHttpUrlSpec,
	Id: *string,
	JobSpec: github.com/cdktf/cdktf-provider-databricks-go/databricks/v10.mlflowWebhook.MlflowWebhookJobSpec,
	ModelName: *string,
	Status: *string,
}
```
