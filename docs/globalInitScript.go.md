...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v10/globalinitscript"
...
&globalinitscript.GlobalInitScriptConfig {
	...
	Position: *f64,
	Source: *string,
	Timeouts: github.com/cdktf/cdktf-provider-databricks-go/databricks/v10.globalInitScript.GlobalInitScriptTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-databricks.globalInitScript.GlobalInitScriptConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.26.0/docs/resources/global_init_script#enabled GlobalInitScript#enabled}. |
...
| <code><a href="#@cdktf/provider-databricks.globalInitScript.GlobalInitScriptConfig.property.position">Position</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.26.0/docs/resources/global_init_script#position GlobalInitScript#position}. |
