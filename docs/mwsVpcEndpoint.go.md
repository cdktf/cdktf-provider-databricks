...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v9/mwsvpcendpoint"
...
&mwsvpcendpoint.MwsVpcEndpointConfig {
	...
	GcpVpcEndpointInfo: github.com/cdktf/cdktf-provider-databricks-go/databricks/v9.mwsVpcEndpoint.MwsVpcEndpointGcpVpcEndpointInfo,
	Id: *string,
	Region: *string,
	State: *string,
	UseCase: *string,
