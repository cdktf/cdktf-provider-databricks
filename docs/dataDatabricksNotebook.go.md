...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v8/datadatabricksnotebook"
...
| <code><a href="#@cdktf/provider-databricks.dataDatabricksNotebook.DataDatabricksNotebookConfig.property.objectId">ObjectId</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.19.0/docs/data-sources/notebook#object_id DataDatabricksNotebook#object_id}. |
