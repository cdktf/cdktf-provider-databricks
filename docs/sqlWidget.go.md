...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v8/sqlwidget"
...
&sqlwidget.SqlWidgetConfig {
	...
	Id: *string,
	Parameter: interface{},
	Position: github.com/cdktf/cdktf-provider-databricks-go/databricks/v8.sqlWidget.SqlWidgetPosition,
	Text: *string,
	Title: *string,
