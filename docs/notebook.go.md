...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v8/notebook"
...
| <code><a href="#@cdktf/provider-databricks.notebook.NotebookConfig.property.objectId">ObjectId</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.19.0/docs/resources/notebook#object_id Notebook#object_id}. |
