...
| <code><a href="#@cdktf/provider-databricks.gitCredential.GitCredential.property.isDefaultForProviderInput">IsDefaultForProviderInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-databricks.gitCredential.GitCredential.property.isDefaultForProvider">IsDefaultForProvider</a></code> | <code>object</code> | *No description.* |
...
```csharp
public object IsDefaultForProviderInput { get; }
```
...
```csharp
public object IsDefaultForProvider { get; }
```
...
new GitCredentialConfig {
    ...
    string Id = null,
    object IsDefaultForProvider = null,
    string Name = null,
...
| <code><a href="#@cdktf/provider-databricks.gitCredential.GitCredentialConfig.property.force">Force</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.86.0/docs/resources/git_credential#force GitCredential#force}. |
...
| <code><a href="#@cdktf/provider-databricks.gitCredential.GitCredentialConfig.property.isDefaultForProvider">IsDefaultForProvider</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.86.0/docs/resources/git_credential#is_default_for_provider GitCredential#is_default_for_provider}. |
...
```csharp
public object IsDefaultForProvider { get; set; }
```
