...
// https://registry.terraform.io/providers/databricks/databricks/1.94.0/docs/resources/quality_monitor_v2
...
export class QualityMonitorV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QualityMonitorV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.94.0/docs/resources/quality_monitor_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.94.0/docs/resources/quality_monitor_v2 databricks_quality_monitor_v2} Resource
  *
  * @param scope The scope in which to define this construct
