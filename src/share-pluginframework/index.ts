// https://registry.terraform.io/providers/databricks/databricks/1.67.0/docs/resources/share_pluginframework
...
export class SharePluginframework extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SharePluginframework that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.67.0/docs/resources/share_pluginframework#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.67.0/docs/resources/share_pluginframework databricks_share_pluginframework} Resource
  *
  * @param scope The scope in which to define this construct
