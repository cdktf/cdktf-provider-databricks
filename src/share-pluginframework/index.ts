...
// https://registry.terraform.io/providers/databricks/databricks/1.58.0/docs/resources/share_pluginframework
...
export class SharePluginframework extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SharePluginframework that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.58.0/docs/resources/share_pluginframework#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.58.0/docs/resources/share_pluginframework databricks_share_pluginframework} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SharePluginframeworkConfig) {
    ...
    this._effectiveOwner = config.effectiveOwner;
  ...
  // effective_owner - computed: true, optional: true, required: false
  private _effectiveOwner?: string; 
  public get effectiveOwner() {
    return this.getStringAttribute('effective_owner');
  }
  public set effectiveOwner(value: string) {
    this._effectiveOwner = value;
  }
  public resetEffectiveOwner() {
    this._effectiveOwner = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get effectiveOwnerInput() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      effective_owner: cdktf.stringToTerraform(this._effectiveOwner),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      effective_owner: {
        value: cdktf.stringToHclTerraform(this._effectiveOwner),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
