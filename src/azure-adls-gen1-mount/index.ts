// https://registry.terraform.io/providers/databricks/databricks/1.81.0/docs/resources/azure_adls_gen1_mount
...
export class AzureAdlsGen1Mount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureAdlsGen1Mount that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.81.0/docs/resources/azure_adls_gen1_mount#import import section} in the documentation of this resource for the id to use
