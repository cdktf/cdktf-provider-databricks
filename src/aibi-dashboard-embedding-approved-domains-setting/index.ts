...
// https://registry.terraform.io/providers/databricks/databricks/1.86.0/docs/resources/aibi_dashboard_embedding_approved_domains_setting
...
export class AibiDashboardEmbeddingApprovedDomainsSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AibiDashboardEmbeddingApprovedDomainsSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.86.0/docs/resources/aibi_dashboard_embedding_approved_domains_setting#import import section} in the documentation of this resource for the id to use
