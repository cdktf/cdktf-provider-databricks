...
// https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/permissions
...
export class Permissions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Permissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: PermissionsConfig) {
    ...
    this._alertV2Id = config.alertV2Id;
  ...
  // alert_v2_id - computed: false, optional: true, required: false
  private _alertV2Id?: string; 
  public get alertV2Id() {
    return this.getStringAttribute('alert_v2_id');
  }
  public set alertV2Id(value: string) {
    this._alertV2Id = value;
  }
  public resetAlertV2Id() {
    this._alertV2Id = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get alertV2IdInput() {
    return this._alertV2Id;
  }
  ...
  // database_instance_name - computed: false, optional: true, required: false
