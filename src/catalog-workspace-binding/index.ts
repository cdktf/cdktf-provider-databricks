// https://registry.terraform.io/providers/databricks/databricks/1.39.0/docs/resources/catalog_workspace_binding
...
export class CatalogWorkspaceBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CatalogWorkspaceBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.39.0/docs/resources/catalog_workspace_binding#import import section} in the documentation of this resource for the id to use
