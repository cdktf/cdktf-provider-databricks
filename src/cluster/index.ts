...
// https://registry.terraform.io/providers/databricks/databricks/1.96.0/docs/resources/cluster
...
export function clusterProviderConfigToTerraform(struct?: ClusterProviderConfigOutputReference | ClusterProviderConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function clusterProviderConfigToHclTerraform(struct?: ClusterProviderConfigOutputReference | ClusterProviderConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ClusterProviderConfigOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ClusterProviderConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: ClusterProviderConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class Cluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.96.0/docs/resources/cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: ClusterConfig) {
    ...
    this._remoteDiskThroughput = config.remoteDiskThroughput;
    ...
    this._totalInitialRemoteDiskSize = config.totalInitialRemoteDiskSize;
  ...
  private _providerConfig = new ClusterProviderConfigOutputReference(this, "provider_config");
  public get providerConfig() {
    return this._providerConfig;
  }
  public putProviderConfig(value: ClusterProviderConfig) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      remote_disk_throughput: cdktf.numberToTerraform(this._remoteDiskThroughput),
      ...
      total_initial_remote_disk_size: cdktf.numberToTerraform(this._totalInitialRemoteDiskSize),
      ...
      provider_config: clusterProviderConfigToTerraform(this._providerConfig.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      remote_disk_throughput: {
        value: cdktf.numberToHclTerraform(this._remoteDiskThroughput),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      total_initial_remote_disk_size: {
        value: cdktf.numberToHclTerraform(this._totalInitialRemoteDiskSize),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      provider_config: {
        value: clusterProviderConfigToHclTerraform(this._providerConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ClusterProviderConfigList",
      },
      timeouts: {
