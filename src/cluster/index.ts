...
// https://registry.terraform.io/providers/databricks/databricks/1.43.0/docs/resources/cluster
...
export interface ClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly cloneFrom?: ClusterCloneFrom;
  /**
...
export function clusterCloneFromToTerraform(struct?: ClusterCloneFromOutputReference | ClusterCloneFrom): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function clusterCloneFromToHclTerraform(struct?: ClusterCloneFromOutputReference | ClusterCloneFrom): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ClusterCloneFromOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ClusterCloneFrom | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: ClusterCloneFrom | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class Cluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.43.0/docs/resources/cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.43.0/docs/resources/cluster databricks_cluster} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ClusterConfig) {
    ...
    this._cloneFrom.internalValue = config.cloneFrom;
  ...
  private _cloneFrom = new ClusterCloneFromOutputReference(this, "clone_from");
  public get cloneFrom() {
    return this._cloneFrom;
  }
  public putCloneFrom(value: ClusterCloneFrom) {
    this._cloneFrom.internalValue = value;
  }
  public resetCloneFrom() {
    this._cloneFrom.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get cloneFromInput() {
    return this._cloneFrom.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      clone_from: clusterCloneFromToTerraform(this._cloneFrom.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      clone_from: {
        value: clusterCloneFromToHclTerraform(this._cloneFrom.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ClusterCloneFromList",
      },
      cluster_log_conf: {
