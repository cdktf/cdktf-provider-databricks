...
export class DataDatabricksJobJobSettingsSettingsTaskLibraryProviderConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDatabricksJobJobSettingsSettingsTaskLibraryProviderConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataDatabricksJobJobSettingsSettingsTaskLibraryProviderConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function dataDatabricksJobJobSettingsSettingsTaskLibraryToHclTerraform(struct?: DataDatabricksJobJobSettingsSettingsTaskLibrary | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    provider_config: {
      value: dataDatabricksJobJobSettingsSettingsTaskLibraryProviderConfigToHclTerraform(struct!.providerConfig),
      isBlock: true,
      type: "list",
      storageClassType: "DataDatabricksJobJobSettingsSettingsTaskLibraryProviderConfigList",
    },
    pypi: {
...
export class DataDatabricksJobJobSettingsSettingsTaskLibraryOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _providerConfig = new DataDatabricksJobJobSettingsSettingsTaskLibraryProviderConfigOutputReference(this, "provider_config");
  public get providerConfig() {
    return this._providerConfig;
  }
  public putProviderConfig(value: DataDatabricksJobJobSettingsSettingsTaskLibraryProviderConfig) {
