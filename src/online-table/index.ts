...
// https://registry.terraform.io/providers/databricks/databricks/1.92.0/docs/resources/online_table
...
export class OnlineTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OnlineTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.92.0/docs/resources/online_table#import import section} in the documentation of this resource for the id to use
