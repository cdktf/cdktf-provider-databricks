// https://registry.terraform.io/providers/databricks/databricks/1.51.0/docs/resources/online_table
...
export class OnlineTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OnlineTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.51.0/docs/resources/online_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: OnlineTableConfig) {
    ...
    this._tableServingUrl = config.tableServingUrl;
  ...
  // table_serving_url - computed: false, optional: true, required: false
  private _tableServingUrl?: string; 
  public get tableServingUrl() {
    return this.getStringAttribute('table_serving_url');
  }
  public set tableServingUrl(value: string) {
    this._tableServingUrl = value;
  }
  public resetTableServingUrl() {
    this._tableServingUrl = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get tableServingUrlInput() {
    return this._tableServingUrl;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      table_serving_url: cdktf.stringToTerraform(this._tableServingUrl),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      table_serving_url: {
        value: cdktf.stringToHclTerraform(this._tableServingUrl),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
