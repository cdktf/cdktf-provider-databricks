...
// https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/resources/workspace_setting_v2
...
export class WorkspaceSettingV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceSettingV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/resources/workspace_setting_v2#import import section} in the documentation of this resource for the id to use
