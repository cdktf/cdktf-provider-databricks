// https://registry.terraform.io/providers/databricks/databricks/1.39.0/docs/resources/default_namespace_setting
...
export class DefaultNamespaceSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultNamespaceSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.39.0/docs/resources/default_namespace_setting#import import section} in the documentation of this resource for the id to use
