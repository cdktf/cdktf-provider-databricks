...
// https://registry.terraform.io/providers/databricks/databricks/1.39.0/docs/resources/mws_storage_configurations
...
export class MwsStorageConfigurations extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MwsStorageConfigurations that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.39.0/docs/resources/mws_storage_configurations#import import section} in the documentation of this resource for the id to use
