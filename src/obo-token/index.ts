...
// https://registry.terraform.io/providers/databricks/databricks/1.39.0/docs/resources/obo_token
...
export class OboToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OboToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.39.0/docs/resources/obo_token#import import section} in the documentation of this resource for the id to use
