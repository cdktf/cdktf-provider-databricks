...
// https://registry.terraform.io/providers/databricks/databricks/1.80.0/docs/data-sources/shares
...
export class DataDatabricksShares extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksShares that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.80.0/docs/data-sources/shares#import import section} in the documentation of this resource for the id to use
