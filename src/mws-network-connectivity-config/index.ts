...
// https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/resources/mws_network_connectivity_config
...
export class MwsNetworkConnectivityConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MwsNetworkConnectivityConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/resources/mws_network_connectivity_config#import import section} in the documentation of this resource for the id to use
