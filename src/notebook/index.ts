// https://registry.terraform.io/providers/databricks/databricks/1.30.0/docs/resources/notebook
...
export class Notebook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Notebook that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.30.0/docs/resources/notebook#import import section} in the documentation of this resource for the id to use
