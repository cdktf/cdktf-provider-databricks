// https://registry.terraform.io/providers/databricks/databricks/1.80.0/docs/data-sources/current_metastore
...
export class DataDatabricksCurrentMetastore extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksCurrentMetastore that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.80.0/docs/data-sources/current_metastore#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.80.0/docs/data-sources/current_metastore databricks_current_metastore} Data Source
  *
  * @param scope The scope in which to define this construct
