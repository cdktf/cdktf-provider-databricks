// https://registry.terraform.io/providers/databricks/databricks/1.79.0/docs/resources/disable_legacy_access_setting
...
export class DisableLegacyAccessSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DisableLegacyAccessSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.79.0/docs/resources/disable_legacy_access_setting#import import section} in the documentation of this resource for the id to use
