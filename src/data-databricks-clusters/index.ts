...
// https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/clusters
...
export interface DataDatabricksClustersConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly providerConfig?: DataDatabricksClustersProviderConfig;
}
...
export interface DataDatabricksClustersProviderConfig {
  /**
...
export function dataDatabricksClustersProviderConfigToTerraform(struct?: DataDatabricksClustersProviderConfigOutputReference | DataDatabricksClustersProviderConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataDatabricksClustersProviderConfigToHclTerraform(struct?: DataDatabricksClustersProviderConfigOutputReference | DataDatabricksClustersProviderConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataDatabricksClustersProviderConfigOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataDatabricksClustersProviderConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataDatabricksClustersProviderConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataDatabricksClusters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _providerConfig = new DataDatabricksClustersProviderConfigOutputReference(this, "provider_config");
  public get providerConfig() {
    return this._providerConfig;
  }
  public putProviderConfig(value: DataDatabricksClustersProviderConfig) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      provider_config: dataDatabricksClustersProviderConfigToTerraform(this._providerConfig.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      provider_config: {
        value: dataDatabricksClustersProviderConfigToHclTerraform(this._providerConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataDatabricksClustersProviderConfigList",
      },
    };
