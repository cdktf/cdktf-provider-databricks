...
// https://registry.terraform.io/providers/databricks/databricks/1.36.2/docs/resources/mws_vpc_endpoint
...
export class MwsVpcEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MwsVpcEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.36.2/docs/resources/mws_vpc_endpoint#import import section} in the documentation of this resource for the id to use
