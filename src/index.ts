...
export * as accountFederationPolicy from './account-federation-policy';
export * as accountNetworkPolicy from './account-network-policy';
export * as accountSettingV2 from './account-setting-v2';
...
export * as appsSettingsCustomTemplate from './apps-settings-custom-template';
...
export * as databaseDatabaseCatalog from './database-database-catalog';
export * as databaseInstance from './database-instance';
export * as databaseSyncedDatabaseTable from './database-synced-database-table';
...
export * as entityTagAssignment from './entity-tag-assignment';
...
export * as policyInfo from './policy-info';
...
export * as servicePrincipalFederationPolicy from './service-principal-federation-policy';
...
export * as workspaceSettingV2 from './workspace-setting-v2';
export * as dataDatabricksAccountFederationPolicies from './data-databricks-account-federation-policies';
export * as dataDatabricksAccountFederationPolicy from './data-databricks-account-federation-policy';
...
export * as dataDatabricksAccountSettingV2 from './data-databricks-account-setting-v2';
...
export * as dataDatabricksAppsSettingsCustomTemplate from './data-databricks-apps-settings-custom-template';
export * as dataDatabricksAppsSettingsCustomTemplates from './data-databricks-apps-settings-custom-templates';
...
export * as dataDatabricksDatabaseDatabaseCatalog from './data-databricks-database-database-catalog';
export * as dataDatabricksDatabaseDatabaseCatalogs from './data-databricks-database-database-catalogs';
...
export * as dataDatabricksDatabaseSyncedDatabaseTable from './data-databricks-database-synced-database-table';
export * as dataDatabricksDatabaseSyncedDatabaseTables from './data-databricks-database-synced-database-tables';
...
export * as dataDatabricksEntityTagAssignment from './data-databricks-entity-tag-assignment';
export * as dataDatabricksEntityTagAssignments from './data-databricks-entity-tag-assignments';
...
export * as dataDatabricksPolicyInfo from './data-databricks-policy-info';
export * as dataDatabricksPolicyInfos from './data-databricks-policy-infos';
...
export * as dataDatabricksServicePrincipalFederationPolicies from './data-databricks-service-principal-federation-policies';
export * as dataDatabricksServicePrincipalFederationPolicy from './data-databricks-service-principal-federation-policy';
...
export * as dataDatabricksTagPolicies from './data-databricks-tag-policies';
export * as dataDatabricksTagPolicy from './data-databricks-tag-policy';
...
export * as dataDatabricksWorkspaceSettingV2 from './data-databricks-workspace-setting-v2';
