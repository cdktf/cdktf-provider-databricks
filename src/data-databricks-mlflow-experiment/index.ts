...
// https://registry.terraform.io/providers/databricks/databricks/1.48.3/docs/data-sources/mlflow_experiment
...
export class DataDatabricksMlflowExperiment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksMlflowExperiment that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.48.3/docs/data-sources/mlflow_experiment#import import section} in the documentation of this resource for the id to use
