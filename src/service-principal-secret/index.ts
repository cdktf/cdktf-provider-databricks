...
// https://registry.terraform.io/providers/databricks/databricks/1.92.0/docs/resources/service_principal_secret
...
export class ServicePrincipalSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePrincipalSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.92.0/docs/resources/service_principal_secret#import import section} in the documentation of this resource for the id to use
