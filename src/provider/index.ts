...
// https://registry.terraform.io/providers/databricks/databricks/1.86.0/docs
...
export class DatabricksProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing DatabricksProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.86.0/docs#import import section} in the documentation of this resource for the id to use
